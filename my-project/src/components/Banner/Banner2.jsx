    ...
    <div className='container py-14'>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
        ...
        <div className='space-y-5 flex justify-center flex-col xl:max-w-[500px]'>
          ...
          initial='initial'
          whileInView={'animate'}
          className='text-gray-500 text-sm leading-7'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Autem enim veritatis quos dolor voluptates delectus adipisci odit repellendus ex eligendi {' '}
          </motion.p>
          <motion.div
