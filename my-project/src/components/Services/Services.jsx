  ...
  return (
    ...
    <div className='container py-20'>
      ...
      <div className='space-y-3 text-center max-w-[350px] mx-auto mb-8'>
        ...
        initial='initial'
        whileInView={'animate'}
        className='text-3xl font-bold font-serif'>What we provide</motion.h1>
        <motion.p
        variants={SlideUp(0.4)}
        initial='initial'
        whileInView={'animate'}
        className='text-gray-500'>Bring your dream home to life with one-on-one design help & hand picked products</motion.p>
      </div>
        ...
        {/* Card section */}
      {
        ServiceCard.map((card) => {
          return (
            ...
            initial='initial'
            whileInView={'animate'}
             key={card.id} className='space-y-4 border-[1px] border-black/30 p-6 hover:bg-black hover:text-white hover:shadow-[7px_7px_0px_0px_#6c6c6c] duration-300'>
